        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            return Scaffold(
              ...
              body: Center(child: Text('Something went wrong', style: TextStyle(fontFamily: 'Montserrat_400', fontSize: 24, color: Colors.white),)),
            );
          }
                    ...
                    Expanded(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color:
                                toggle ? Color(0xFF576EE0) : Colors.transparent,
                          ),
                          child: Center(
                            child: Text(
                              'Sign-Up',
                    ...
                    Expanded(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8),
                            color:
                                toggle ? Colors.transparent : Color(0xFF576EE0),
                ...
                if(!toggle)
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: _loading ? CircularProgressIndicator(color: Colors.white,) : Text('Login', style: TextStyle(color: Colors.white, fontFamily: 'Montserrat_600'),)
                      ),
                    ),
                  ),
                ),
