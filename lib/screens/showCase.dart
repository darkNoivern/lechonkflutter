...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Color(0xFF161927), 'assets/images/lechonk.webp', "Build",
        "Create your own expense journal", "Sahdeep"),
    ItemData(Color(0xFF576EE0), 'assets/images/lechonk.webp', "Discharge",
        "Discharge financial liabilities by paying out bills", "Liquid Swipe"),
    ItemData(Color(0xFF161927), 'assets/images/lechonk.webp', "Wallet",
        "Virtual Wallet for your cards", "Give Star!"),
    ItemData(Color(0xFF576EE0), 'assets/images/lechonk.webp', "Ready, Set ..",
